    ...
    for i in Stock_instock:
        for n in i:
            if n == 'Out of stock':
                ...
                Stock_outstock.sort()
Createstock()
print("this is in stock",Stock_instock)
print("this is out of stock",Stock_outstock)
...
Stock_instock.pop(2)
print("this is in stock after update ",Stock_instock)
print("this is in stock after update ",Stock_outstock)
